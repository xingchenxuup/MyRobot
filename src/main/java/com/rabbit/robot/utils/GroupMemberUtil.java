    ...
    public static String replaceMember(String teamName, List<TeamMemberDO> memberDOS) {
        ...
        for (TeamMemberDO memberDO : memberDOS) {
            originStr = originStr
                    ...
                    .replace("成员" + memberDO.getLocation(),
                            "<span style=\"border-radius:50%\" ><img  src=\"https://jx3kt.oss-cn-shanghai.aliyuncs.com/" + memberDO.getSrc() + "\" style=\"vertical-align:middle;\" ></span>" + memberDO.getMemberName());
