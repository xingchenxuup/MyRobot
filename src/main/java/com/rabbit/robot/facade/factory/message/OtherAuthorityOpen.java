...
@Order(1)
@Slf4j
public class OtherAuthorityOpen implements MessageFacade {
    @Override
    public EnumKeyWord get() {
        return EnumKeyWord.OTHER_AUTHORITY_OPEN;
    }
    ...
    public void execute(Contact sender, Contact group, Message message) throws InterruptedException {
        ...
        Groups.groups.put(group.getId(),true);
        SendHelper.sendSing(group, new PlainText("群聊功能已启动"));
    }
}
