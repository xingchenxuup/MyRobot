...
import com.rabbit.robot.constants.saohua.SaoHua;
 ...
 */
@Component
public class SaoHuaFacade implements MessageFacade {

    @Override
    public EnumKeyWord get() {
        return EnumKeyWord.SAO_HUA;
    }
    ...
    public void execute(Contact sender, Contact group, Message message) {
        ...
        try {
            String result = HttpClient.sendGet(ApiURLConstant.SAOHUA, null);
